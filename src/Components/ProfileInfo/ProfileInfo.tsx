...
const StackDummyData = [
  ...
  },
  {
    id: 2,
    name: "Kotlin",
    icon: "https://blog.kakaocdn.net/dn/vY22B/btqzyimgz4J/fqE900XPQuSHF3JZKPnxPk/img.png",
    proficiency: 90,
    color: "#5A6A94",
  },
  {
  ...
  return (
    <>
      {ProfileData.map(data => (
        <S.ProfileContentWrapper key={data.id}>
          <S.ProfileWrapper>
            <S.ContentWrapper>
              ...
              <S.ProfileInputWrapper>
                ...
                <span
                  style={{ lineHeight: "50px", fontSize: 17, color: "black" }}
                >
                  {data.introduce}
                </span>
                <S.linkWrapper>
